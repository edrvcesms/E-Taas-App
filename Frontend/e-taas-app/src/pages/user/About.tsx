...
export const About = () => {
  ...
  <section className="py-12 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-pink-500/5 to-white">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-pink-500 mb-4 text-2xl font-semibold">About E-TAAS ang Pinay MSMEs</h1>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className="text-pink-500 text-2xl mb-6 font-semibold">About the Program</h2>
          ...
          {/* Program Goals */}
          <div className="mb-12">
            <h2 className="text-pink-500 text-2xl mb-8 text-center font-semibold">Program Goals</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-sm">
                <div className="w-16 h-16 bg-pink-500/10 rounded-full flex items-center justify-center mb-6">
                      <Target className="w-8 h-8 text-pink-500" />
                </div>
                    <h3 className="text-pink-500 text-2xl mb-4 font-semibold">Goal 1: Training & Mentoring</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm">
                ...
                <h3 className="text-pink-500 text-2xl mb-4 font-semibold">Goal 2: Digital Marketing Support</h3>
                <p className="text-gray-700 leading-relaxed">
          ...
          {/* Partners */}
          <div className="mb-12">
            <h2 className="text-pink-500 text-2xl mb-8 text-center font-semibold">Our Partners</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-linear-to-br from-pink-500/5 to-white rounded-2xl p-8 text-center">
                ...
                <h3 className="text-pink-500 text-2xl mb-4 font-semibold">Department of Trade and Industry</h3>
              ...
              <div className="bg-linear-to-br from-pink-500/5 to-white rounded-2xl p-8 text-center">
                ...
                <h3 className="text-pink-500 text-2xl mb-4 font-semibold">National Confederation of Cooperatives</h3>
                <p className="text-gray-700">
          ...
          {/* Key Features */}
              <div className="mb-12">
            <h2 className="text-pink-500 text-2xl mb-8 text-center font-semibold">What We Offer</h2>
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-pink-500 text-2xl mb-2">Dedicated E-Commerce Platform</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-pink-500 text-2xl mb-2">Comprehensive Training Programs</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-pink-500 text-2xl mb-2">One-on-One Mentoring</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-pink-500 text-2xl mb-2">Digital Marketing Support</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-pink-500/5 to-white rounded-2xl p-8">
              <h3 className="text-pink-500 text-2xl mb-4 font-semibold">Our Mission</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-pink-500/5 to-white rounded-2xl p-8">
              <h3 className="text-pink-500 text-2xl mb-4 font-semibold">Our Vision</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-pink-500 mb-6 text-2xl font-semibold">Join the E-TAAS Community</h2>
