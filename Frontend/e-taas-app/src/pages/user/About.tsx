...
export const About = () => {
  return (
    <div>
      {/* Header */}
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#DD5BA3]/5 to-white">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-pink-500 mb-4">About E-TAAS ang Pinay MSMEs</h1>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <h2 className="text-[#DD5BA3] mb-6">About the Program</h2>
          ...
          {/* Program Goals */}
          <div className="mb-12">
            <h2 className="text-[#DD5BA3] mb-8 text-center">Program Goals</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-sm">
                <div className="w-16 h-16 bg-[#DD5BA3]/10 rounded-full flex items-center justify-center mb-6">
                  <Target className="w-8 h-8 text-[#DD5BA3]" />
                </div>
                <h3 className="text-[#DD5BA3] mb-4">Goal 1: Training & Mentoring</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm">
                <div className="w-16 h-16 bg-[#DD5BA3]/10 rounded-full flex items-center justify-center mb-6">
                  <TrendingUp className="w-8 h-8 text-[#DD5BA3]" />
                </div>
                <h3 className="text-[#DD5BA3] mb-4">Goal 2: Digital Marketing Support</h3>
                <p className="text-gray-700 leading-relaxed">
          ...
          {/* Partners */}
          <div className="mb-12">
            <h2 className="text-[#DD5BA3] mb-8 text-center">Our Partners</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-linear-to-br from-[#DD5BA3]/5 to-white rounded-2xl p-8 text-center">
                <div className="w-24 h-24 bg-[#DD5BA3] rounded-full mx-auto mb-6 flex items-center justify-center">
                  <span className="text-white text-4xl">DTI</span>
                </div>
                <h3 className="text-[#DD5BA3] mb-4">Department of Trade and Industry</h3>
              ...
              <div className="bg-linear-to-br from-[#DD5BA3]/5 to-white rounded-2xl p-8 text-center">
                <div className="w-24 h-24 bg-[#DD5BA3] rounded-full mx-auto mb-6 flex items-center justify-center">
                  <span className="text-white text-2xl">NATCCO</span>
                </div>
                <h3 className="text-[#DD5BA3] mb-4">National Confederation of Cooperatives</h3>
                <p className="text-gray-700">
          ...
          {/* Key Features */}
          <div className="mb-12">
            <h2 className="text-[#DD5BA3] mb-8 text-center">What We Offer</h2>
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-[#DD5BA3]/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <Users className="w-6 h-6 text-[#DD5BA3]" />
                </div>
                <div>
                  <h3 className="text-[#DD5BA3] mb-2">Dedicated E-Commerce Platform</h3>
              ...
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-[#DD5BA3]/10 rounded-full flex items-center justify-center 041shrink-0">
                  <Award className="w-6 h-6 text-[#DD5BA3]" />
                </div>
                <div>
                  <h3 className="text-[#DD5BA3] mb-2">Comprehensive Training Programs</h3>
              ...
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-[#DD5BA3]/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <Target className="w-6 h-6 text-[#DD5BA3]" />
                </div>
                <div>
                  <h3 className="text-[#DD5BA3] mb-2">One-on-One Mentoring</h3>
                  <p className="text-gray-700">Personalized guidance from experienced entrepreneurs and business coaches to help you grow.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-[#DD5BA3]/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <TrendingUp className="w-6 h-6 text-[#DD5BA3]" />
                </div>
                <div>
                  <h3 className="text-[#DD5BA3] mb-2">Digital Marketing Support</h3>
          ...
          {/* Mission & Vision */}
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-[#DD5BA3]/5 to-white rounded-2xl p-8">
              <h3 className="text-[#DD5BA3] mb-4">Our Mission</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-[#DD5BA3]/5 to-white rounded-2xl p-8">
              <h3 className="text-[#DD5BA3] mb-4">Our Vision</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-[#DD5BA3] mb-6">Join the E-TAAS Community</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="px-8 py-3 bg-[#DD5BA3] text-white rounded-full hover:opacity-90 transition-opacity">
              Become a Seller
            </button>
            <button className="px-8 py-3 border-2 border-[#DD5BA3] text-[#DD5BA3] rounded-full hover:bg-[#DD5BA3]/5 transition-colors">
              Shop Products
            </button>
          </div>
        </div>
