...
const Home: React.FC = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#DD5BA3]/5 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-pink-500 mb-6">Your Trusted Marketplace for Filipino MSMEs</h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-pink-500 mb-2">500+</div>
            ...
            <div className="text-center">
              ...
              <div className="text-pink-500 mb-2">2,000+</div>
            ...
            <div className="text-center">
              ...
              <div className="text-[#DD5BA3] mb-2">95%</div>
            ...
            <div className="text-center">
              ...
              <div className="text-pink-500 mb-2">100%</div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-center text-pink-500 mb-12">Why Shop With Us?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-pink-500 mb-4">Verified Sellers</h3>
            ...
            <div className="bg-white rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-pink-500 mb-4">Support Local</h3>
            ...
            <div className="bg-white rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-pink-500 mb-4">Quality Products</h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-pink-500 mb-6">Ready to Get Started?</h2>
